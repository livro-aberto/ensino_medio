...
Uma segunda estação de pesquisa `B` está situada à 10 km ao norte de `A`. Considerando os dados da Parte 3, como você informaria a posição do grupo de exploradores
com relação à estação `B`?
