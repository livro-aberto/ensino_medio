...
.. admonition:: Para o professor
   ...
   **Tópicos que serão tratatos o capítulo**
   ...
   * apresenta-se o vetor deslocamento nulo e o vetor deslocamento simétrico.
   ...
   A operação de multiplicação de um vetor por um número real é interpretada geometricamente no contexto de homotetias
