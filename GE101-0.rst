...
Ao medir o comprimento da linha da trajetória estamos associando a ela um número real positivo. A esse número daremos o nome de :index:`distância percorrida`. Como já sabemos, grandeza escalar é aquela que pode ser caracterizada apenas por um número real e uma unidade de medida. Por isso, a distância percorrida é uma grandeza escalar.
...
.. admonition:: Exemplo 
   ...
   A figura abaixo [INSERIR] contém o mapa de parte do bairro onde mora e trabalha a professora Ana. Desconsiderando o tempo que ela fica parada nos sinais de trânsito para atravessar a rua, Ana gasta 12 minutos para sair de sua casa e chegar na escola todos os dias.
   
   [INSERIR FIGURA]
   
   Ao sair de sua casa (ponto A da figura) em direção à escola onde trabalha (ponto B da figura), Ana escolheu virar a esquerda, depois seguir em frente, atravessar a rua, então virar a esquerda novamente e seguir andando mais um pouco para chegar ao seu destino final. A trajetória percorrida por ela foi marcada em rosa na imagem abaixo da esquerda. Com o auxílio de algum instrumento de medida, seja físico ou computacional, é possível medir a distância percorrida associada à trajetória de Ana. 
   
   Agora, unindo o ponto A (ponto inicial da trajetória de Ana) ao ponto B (ponto final da trajetória de Ana), obteremos o deslocamento de Ana para ir de sua casa à escola. O vetor `\overrightarrow{AB}` que representa essa grandeza está mostrado na figura da direita.
