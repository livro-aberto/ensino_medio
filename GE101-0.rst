...
.. admonition:: Para o professor
   ...
   * apresenta-se o vetor deslocamento nulo e o vetor deslocamento simétrico.
   ...
   Registramos aqui uma analogia que pode ser útil para uma reflexão sobre o ensino e a aprendizagem de vetores: este tópico tem muito em comum com tópico dos números racionais. De fato:
...
.. admonition:: Para o professor
   ...
   * Perceber que grandezas vetoriais podem ser representadas geometricamente por outros meios (no caso, flechas de mesmo tamanho para representar direção e sentido e uma escala de corer para representar o módulo).
