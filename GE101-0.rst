...
.. admonition:: Habilidade
   ...
   BNCC (EM11MT01) Comprender o conceito de vetor, tanto do ponto de vista geométrico (coleção de segmentos orientados de mesmo comprimento, direção e sentido) quanto do ponto de vista algébrico, caracterizado por suas coordenadas, aplicando-o em situações da Física.   
...
.. admonition:: Definição   certo
   

  
  ainda no bilhete
  
agora é texto normal
...
.. admonition:: O que é ensinado?
   ...
   * Representação de deslocamento, velocidade, aceleração, força e translação usando vetores.
   
.. admonition:: Por que estudar do assunto?
