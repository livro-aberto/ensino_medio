...
.. admonition:: Para o professor
   ...
   Estudos educacionais mostram que os alunos têm a forte tendência em confundir o vetor deslocamento com a trajetória percorrida pelo objeto que se desloca. No sentido de minimizar o efeito deste distrator, caso haja a disponibilidade de um projetor multimídia acoplado a um computador, *tablet* ou *smartphone*, sugerimos o uso da construção GeoGebra disponível no endereço <`https://www.geogebra.org/m/f8GCVdyx <https://www.geogebra.org/m/f8GCVdyx>`_>. Com ela, à título de ilustração dinâmica, é possível visualizar diversos tipos de deslocamentos entre dois pontos do modelo da pista de Interlagos apresentado na :numref:`fig-geometria-deslocamento-01`.   
