...
Vetores iguais. Dados dois vetores em uma malha, determinar se são iguais ou não. Usar malhas não retangulares. Fazer uma atividade similar, mas eletrônica, para mover um vetor até fazê-lo coincidir com outro.
