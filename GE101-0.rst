...
.. admonition:: Para o professor
   ...
   **(FIQUEI COM DÚVIDA... Este é um esqueleto para o texto dirigido ao professor ou já é uma versão inicial? Estou fazendo uma proposta)**
...
Chama-se **grandeza escalar** aquela que se pode representar por um número real.**[Essa é a definição de grandeza escalar? Acho ruim a palavra representar. A representação de uma grandeza pode se dar por uma letra, por exemplo. Talvez: Chama-se grandeza escalar aquela que pode ser caracterizada por apenas um número real.] ** São exemplos de grandezas escalares: temperatura, umidade relativa do ar, distância, tempo e massa. Note que é possível expressar uma informação quantitativa sobre esses conceitos apresentando apenas um número seguido da unidade de medida estabelecida. Por exemplo, no sistema internacional de unidades, graus Celsius para temperatura, metros para distância, horas para o tempo e quilogramas para massa. 
