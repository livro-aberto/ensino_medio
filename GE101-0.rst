...
Antes de prosseguirmos, é importante observar que, em particular, *o vetor de posição relativa depende da escolha do ponto de referência* uma vez que os vetores posições são diferentes. Assim, ao se mudar o ponto de referência, os vetores posições relativas também mudam.
