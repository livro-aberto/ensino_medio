...
.. admonition:: Objetivos específicos
   ...
   (EM15MT02) Estabelecer relação entre a representação geométrica de uma reta no plano cartesiano e os coeficientes de sua representação algébrica, inclusive no contexto da função afim. 
