...
Um gráfico alternativo ao histograma para representar variáveis quantitativas, muito utilizado na Estatística, é conhecido como :index:`boxplot` (gráfico caixa). A construção desse gráfico é baseada em  cinco medidas de posição, que compõem o :index:`esquema dos cinco números`, a saber,  
