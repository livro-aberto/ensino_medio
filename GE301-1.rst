...
.. figure:: _resources/projecao-paralela-03.jpg
   ...
   `P'` é a projeção paralela do ponto `P` com relação a direção dada pela reta `d` e ao plano de projeção `\pi`.
...
.. figure:: _resources/projecao-paralela-02_1.jpg
   ...
   `P'` é a projeção ortogonal do ponto `P` com relação a direção dada pela reta `d` perpendicular ao plano de projeção `\pi`.
