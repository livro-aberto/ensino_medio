...
.. HJB: não esquecer de falar o caso em que o observador está entre o plano de projeção e o objeto, situação que modela câmeras obscuras.
...
Se a direção do vetor `\vec{v}` for perpendicular ao plano `\pi`, então a projeção paralela é denominada :index:`projeção ortogonal`. Uma projeção paralela que não é ortogonal é denominada :index:`projeção oblíquoa`.
