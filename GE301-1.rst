...
Suponha que a cena seja composta por um cubo, como no caso da :numref:`fig-proj-janela-de-alberti-03`. Cada ponto do cubo está emitindo um raio luminoso para o olho do observador. Ao posicionar o quadro frente a cena, basta então desenharmos os pontos de interseção destes raios com o plano do quadro. Como o ponto do quadro e o ponto do cubo estão alinhados com o olho do observador, este não notará a diferença.
