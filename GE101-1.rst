...
.. admonition:: Para o professor
   ...
   **Objetivos específicos:** Usar a representação geométrica de vetores numa malha quadriculada para descrevê-los em termos de combinações lineares dos vetores canônicos da malha.
...
.. admonition:: Para o professor
   ...
   **Objetivos específicos:** 
   ...
   #. Construir um sistema de coordenadas cartesianas a partir de um par de vetores de módulo 1 e perpendiculares entre si.
   #. Reconhecer que as coordenadas de um vetor relativas a estes dois vetores de referência coincidem com as coordenadas da extremidade do vetor quando posicionamos a origem do vetor na origem do sistema de coordenadas.
