...
Nesta seção você vai aprender a representar vetores através de uma lista de números que serão chamados de coordenadas do vetor. Esta representação possibilita que os computadores entendam e operem com vetores.
