...
Uma translação de pontos do plano por `\vec{v}` é a correspondência que associa a cada ponto `P` do plano o ponto `P'=P+\vec{v}` (lembre-se que isto é o mesmo que `\overrightarrow{OP'}=\overrightarrow{OP} + \vec{v}`).

.. figure:: https://drive.google.com/open?id=0B1V1Qzs7JbkKQkJBY2hxb2xkNDQ
   :width: 200px
   :align: center
...
.. figure:: https://drive.google.com/open?id=0B1V1Qzs7JbkKblRsNnNaVUZZNWs
   :width: 200px
   :align: center
...
**Sistematiza o fato de que as coordenadas da soma é a soma das coordenadas.**
