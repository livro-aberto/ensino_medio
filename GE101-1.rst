...
Esta identificação de pontos do plano com vetores através das coordenadas deve trazer um novo olhar sobre os pontos do plano, pois daqui para frente fará sentido somar dois pontos e multiplicar um ponto por um número real.
...
.. admonition:: Resposta 
   ...
   .. tikz:: 
      ...
      \draw[-latex, thick, blue] (1,1) -- (1.5,1.5);
