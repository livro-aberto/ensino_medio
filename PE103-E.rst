...
.. admonition:: Respostas 
 ...
 `5.` Considere a lista dos 300 funcionários em ordem alfabética: a cada funcionário corresponde uma posição de 1 a 300. Temos que `\frac{300}{50}=6`. Sorteie ao acaso um número entre 1 e 6, por exemplo 5. Agora considere os 50 primeiros termos de uma Progressão Aritmética de primeiro termo 5 e razão 6: 5, 11, 17, ..., 299. Selecione então os 50 funcionários correspondentes a essas posições na listagem em ordem alfabética.
