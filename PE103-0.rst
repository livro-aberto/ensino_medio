...
.. Está faltando um número 9 para o medicamento X que está com um dado a menos. Os números estão muito juntos. Formato da tabela precisa melhorar, talvez dispor os dados em colunas em vez de linhas.
...
.. admonition:: Definição 
   ...
   Chamamos de **variável** estatística cada informação que é obtida numa pesquisa. Por exemplo, no caso do problema da escolha do fornecedor, a informação foi diâmetro do parafuso. Dizemos nesse caso que a variável observada foi o diâmetro dos parafusos. Na comparação dos medicamentos, a variável observada foi o tempo de cura da dor de cabeça. Na PNAD observam-se várias variáveis.
