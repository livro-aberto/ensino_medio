...
#. Usando  a divisão regular do intervalo de 3 a 8 proposta na tabela a seguir, complete-a. Cada classe representa um intervalo fechado à esquerda e aberto à direita, isto quer dizer que, o limite inferior não se inclui e o limite superior está incluso, como se explicita na tabela.
   ...
   | [ 7,5 ; 8,0 )       |                             |
   +---------------------+-----------------------------+
Para visualizar o comportamento desses dados, iremos construir um gráfico chamado **histograma**, composto por retângulos adjacentes cujas alturas representam a frequência de observações que caem no  intervalo correspondente. A base de cada retângulo corresponde aos limites do intervalo definido no agrupamento dos dados.
