...
.. Classificação de variáveis de uma pesquisa

.. Produzindo informações de taxas a partir de dados reais de saúde...

.. Refazer os gráficos do infográfico, traduzir o de setores pra barra e visceversa

.. Analizar gráfico de barras de inflação da Globo como exemplo do uso de barras inadequadas
