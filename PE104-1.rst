...
Os :index:`quartis<quartis>` de uma distribuição de frequências ou conjunto de valores numéricos são três medidas, denotadas por Q1, mediana e Q3, que repartem os dados em quatro intervalos de frequências relativas iguais a `\frac{1}{4}`. 
