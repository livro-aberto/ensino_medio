...
.. table:: 100 melhores tempos de finalização da Maratona de Nova Iorque 2017 para mulheres (Horas em número decimal)
  ...
  +----+-------+-------+-------+-------+-------+-------+-------+-------+-------+-------+
  | 10 | 2,529 | 2,669 | 2,827 | 2,894 | 2,949 | 2,974 | 2,99  | 3,021 | 3,059 | 3,085 |
  +----+-------+-------+-------+-------+-------+-------+-------+-------+-------+-------+
...
1. Consideremos agora os dados da categoria de Homens da Maratona da Cidade de Nova York do ano 2017. Observa a tabela com os dados e os histograma a seguir.

   .. table:: 100 melhores tempos de finalização da Maratona de Nova Iorque 2017 para homens (Horas em número decimal)
   ...
   Calcula a média (Soma em horas decimais: 251,1617). Calcula e transforma as medidas de posição calculadas para a categoria de homens, e confere os resultados obtidos para a categoria de mulheres na :ref:`ativ-maratona-de-NY`:

   * Primeiro quartil (`Q1`), tempo necessário para ficar entre os primeiros 25.
   * Mediana (tempo necessário para ficar entre os primeiros 50)
   * Terceiro quartil (`Q3`), tempo necessário para ficar entre os primeiros 75.
