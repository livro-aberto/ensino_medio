.. admonition:: Para o professor
  ...
  **Organizando as ideias 2: Medidas de dispersão**  Definições de amplitude; distância entre quartis; desvio-médio; variância e desvio padrão.
...
#. um valor representativo ou médio do conjunto: pertence ao intervalo delimitado pelos valores extremos do conjunto (mínimo e máximo);
#. dispersão: uma medida de quanto os valores variam no conjunto;
#. forma da distribuição: simétrica, assimétrica, multimodal, etc;
#. valores atípicos: valores que destoam em relação a grande maioria dos dados no conjunto.

Ao longo deste capítulo veremos como as medidas que serão estudadas nos ajudam a revelar estas características do conjunto de dados.
...
Na figura a seguir veja um histograma das notas sem a bonificação, em que os intervalos de classe considerados foram `[0,2[, \quad [2,4[, \quad [4,6[, \quad [6,8]`. Os números entre parênteses correspondem às frequências absolutas.
...
#. Considerando a figura :ref:`fig-histogramas-notas-com-bonificacoes`, identifique qual deles corresponde ao  acréscimo de 1,0 ponto e qual deles corresponde ao aumento de 20%.
...
1. Construa um histograma destes dados, completando a tabela a seguir, que indica os intervalos de classe. Que características da distribuição dos 100 melhores tempos para mulheres podem ser destacadas, analisando-se o histograma construído?
...
4. Considerando as marcações realizadas no item anterior, determine aproximadamente as medidas das áreas no histograma correspondentes aos seguintes intervalos
