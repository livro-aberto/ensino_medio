...
.. admonition:: Resposta
  ...
  `9.` `a=1, b=c=3, d=e=2, f=1, x=3` e `m=0`
...
#. Por que ao se modelar uma projeção paralela por meio de uma função, supõe-se que a direção do vetor `\vec{v}` não é paralela ao plano `\pi`?
