...
.. admonition:: Para o professor
   ...
   **Abordagem adotada no capítulo**
   ...
   As aplicações dos modelos matemáticos ao longo do capítulo se dá principalmente com relação a pinturas, mas as articulações e aplicações são muitas e variadas. No final do capítulo apresentamos uma lista de referências e sugestões de projetos que incluem temas como projeção mapeada, técnicas de cinema, jogos de computador e de tabuleiro, teatro, história das Artes, etc.
