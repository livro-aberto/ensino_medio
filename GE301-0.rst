...
.. admonition:: Para o professor
   ...
   **Observação:** os dois exemplos a seguir mostram que a parte visual do nosso cérebro pode não reconhecer movimentos de translação e rotação como isometrias. 

#. Observe a :numref:`fig-proj-ponzo`. Qual carro é maior?
...
#. Observe a :numref:`fig-proj-shepard`. Qual mesa é mais comprida?
