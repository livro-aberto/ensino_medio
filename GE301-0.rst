...
.. admonition:: Para o professor
   ...
   * Durante a execução da atividade, circule entre os alunos e observe os desenhos. É importante que, nesta etapa, você já diagnostique as habilidades de representação de seus alunos para a discussão que será feita logo após a atividade. Observe, por exemplo, se as posições relativas dos sólidos foram desenhadas corretamente, um atributo que, segundo [Ebersbach-et-al-2011]_ e [Willats-1977]_, exige maturidade e flexibilidade cognitivas que normalmente se desenvolvem por volta dos 11 anos.
