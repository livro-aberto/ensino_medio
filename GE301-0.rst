...
.. HJB: indicar na parte do professor que as projeções em perspectiva é uma oportunidade do aluno apreciar uma característica da matemática: fenômenos diferentes (sombras, pinturas, câmeras) serem modeladas por um mesmo objeto matemático (projeções em perspectiva).
