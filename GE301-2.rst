...
.. admonition:: Para o professor
   ...
   * Sugerimos fortemente que, para a discussão sobre esta atividade, você use com seus alunos as construções do GeoGebra 3D disponíveis nos endereços <https://www.geogebra.org/m/X2rA45gS> (projeção da sinalização de solo no para-brisa),  <https://www.geogebra.org/m/xjMqSPX2> (projeção do para-brisa no solo), <https://www.geogebra.org/m/Uxtn6hxy> (peça "Squaring The Circle").
   
   * Este vídeo <https://youtu.be/pNjh1Ji_rg8> explica, com o uso do GeoGebra para celulares, a construção da peça "Squaring The Circle".
...
Como construir uma tal peça? Aqui, é suficiente que você descreva um procedimento matemático de como obtê-la: você não precisa explicitar equações que descrevam o formato geométrico da peça. 
