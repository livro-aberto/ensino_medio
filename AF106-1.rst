...
.. admonition:: Resposta 
   ...
   b) A resposta deste item depende das escolhas feitas no item anterior.
   
   c) As velocidades médias serão: `1,33` km/min para os períodos de `5:00 - 7:00` e `21:00 - 23:00`, `1,14` km/min para os períodos do dia `11:00 - 13:00` e `13:00 - 15:00`, `1,00` km/min para os períodos de `7:00 - 9:00` e `15:00 - 17:00`, `0,89` km/min entre `9:00 - 11:00`, `0,67` km/min entre `19:00 - 21:00` e `0,5` km/min no período compreendido entre `21:00 - 23:00`.
   
   d) Não. Como a velocidade média é calculada efetuando a divisão da distância percorrida pelo tempo gasto no percurso, uma vez que o trecho considerado é o mesmo, diferentes tempos de travessia da ponte irão sempre resultar em velocidades médias diferentes.
