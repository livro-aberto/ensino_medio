...
.. admonition:: Para o professor
   ...
   * Uma das atividades iniciais, " :ref:`_ativ-nas-ruas`", pede que os alunos façam uma estimativa. Estimule estimativas sem cálculo para comparar com o resultado que posteriormente será encontrado.
   * A seção :ref:`_sec-organizando2` é tão importante quanto delicada, pois trata da metodologia de demonstração. Um dos aspectos fundamentais de separação de **Hipótese** e **Tese** deve ser reforçado a exaustão. Convide, sempre que possível, seus alunos a reescrever teoremas que eles já têm familiaridade usando a estrutura de "Se Hipótese, então Tese".
