...
.. tikz::
   ...
   \begin{scope}[scale=.3]
   \tikzset{>=latex}
   \draw[->,line width=0.8pt,color=primario] (-1.66,-0.1) -- (0.84,2.);
   \draw[line width=0.8pt,dotted] (0.84,2.) circle (3.2649655434629015cm);
   \draw[fill=primario] (-1.66,-0.1) circle (1.5pt);
   \node[left] at (-1.7,0.24) {$A$};
   \draw[fill=primario] (0.84,2.) circle (1.5pt);
   \node[above] at (0.8,2.3) {$B$};
   \end{scope}
...
.. admonition:: Resposta
   ...
   #. É o ponto que `C` que é o simétrico do ponto `A` com relação ao ponto `B`. Para este `C`, `|\overrightarrow{AB} + \overrightarrow{BC}| = 10~\text{cm}`.
      ...
      .. tikz::
         ...
         \draw [line width=0.8pt,dotted] (0.84,2.) circle (3.2649655434629015cm);
         \draw [fill=primario] (-1.66,-0.1) circle (1.5pt);
         \draw (-1.7,0.24) node {$A$};
         \draw [fill=primario] (0.84,2.) circle (1.5pt);
         \draw (0.8,2.3) node {$B$};
         \draw [fill=primario] (3.34,4.1) circle (1.5pt);
         \draw (3.54,4.3) node {$C$};
         \draw [->,line width=0.8pt,color=primario] (0.84,2) -- (3.34,4.1);
   ...
   #. É o ponto que `C = A`. Para este `C`, `|\overrightarrow{AB} + \overrightarrow{BC}| = 0~\text{cm}`.
      ...
      .. tikz::
         ...
         \draw (0.8,2.3) node {$B$};
         \draw (-1.7,-0.4) node {$C$};
         \draw [->,line width=0.8pt,color=primario] (0.84,2) -- (-1.66,-0.1);
   ...
   #. O ponto `C` pertencente à circunferência de centro em `B` e raio `\frac{1}{2} |\overrightarrow{AB}|` que torna o valor de `|\overrightarrow{AB} + \overrightarrow{BC}|` o maior é possível apresentado na figura a seguir. Para este `C`, `|\overrightarrow{AB} + \overrightarrow{BC}| = 7{,}5~\text{cm}`.
      ...
      .. tikz::
         ...
         \draw [fill=primario] (0.84,2.) circle (1.5pt);
         \draw (0.8,2.3) node {$B$};
         \draw [fill=primario] (2.0876,3.0492) circle (1.5pt);
         \draw (2.1,3.37) node {$C$};
         \draw [->,line width=0.8pt,color=primario] (0.84,2) -- (2.0876,3.0492);
      ...
      .. tikz::
         ...
         \draw [fill=primario] (0.84,2.) circle (1.5pt);
         \draw (0.8,2.3) node {$B$};
         \draw [fill=primario] (-0.4048,0.9514) circle (1.5pt);
         \draw (-0.3957,1.2975) node {$C$};
         \draw [->,line width=0.8pt,color=primario] (0.84,2) -- (-0.4048,0.9514);
         \draw [->,line width=0.8pt,color=primario] (-1.66,-0.1) -- (-0.4048,0.9514);
