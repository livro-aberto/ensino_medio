...
Vários jogos concretos ou digitais utilizam projeções, sejam elas apenas para criar a cena do jogo ou como uma componente da dinâmica do jogo. É claro que as projeções, neste caso, aparecem de uma forma mais informal do que a estudada neste capítulo, mas por trás da confecção do jogo, toda a Matemática discutida neste capítulo certamente foi utilizada. 

Vamos listar alguns jogos que envolvem projeção a seguir. Utilize tudo que você aprendeu até aqui e se divirta!

**Jogos concretos:**

* La Boca: neste jogo, o jogador escolhe um outro jogador dentre os demais competidores que o ajudará a construir um sólido geométrico com um conjunto de blocos menores fornecidos pelo jogo. Cada jogador terá acesso à informações de apenas uma face do sólido (uma vista do sólido), sendo uma oposta à outra, e assim, cooperativamente eles devem fazer a construção. As jogadas são pontuadas para o par de jogadores de acordo com o tempo gasto na montagem, mas a pontuação final é individual e feita pela soma de todas as jogadas.
...
O vídeo em português disponível em <https://www.youtube.com/watch?v=n7yiM_zak0Y> vai te ajudar a entender melhor o andamento do jogo. São apenas 3 minutos de vídeo.
