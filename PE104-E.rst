...
Usando todas as ferramentas estudadas neste capítulo, ajude este professor, fazendo um relatório detalhado e comparativo sobre as duas turmas. Se preferir, você poderá baixar estes dados no **link**, mas lembre-se que como eles estão registrados no GeoGebra, a vírgula foi trocada por ponto. 
...
Um material suporte para as atividades deste capítulo foi preparado e está disponível no <**link**>. Para utilizá-lo é necessário ter o GeoGebra instalado em seu computador, tablet ou celular. Com este applet, você poderá, gerar vários conjuntos de dados e observar como ficam os respectivos histograma e boxplot. Além disso, você também poderá inserir os valores de um conjunto de dados em particular para obter várias das medidas resumo trabalhadas neste capítulo, além de obter o histograma e o boxplot. 
